...
describe("ReviewSerializer", () => {
  ...
  describe("Plain object handling (without dataValues)", () => {
    it("should serialize plain objects without dataValues property", () => {
      const plainReviews = [
        {
          id: 1,
          userId: 10,
      ...
      const result = ReviewSerializer.serializeArray(plainReviews);
    ...
    it("should serialize plain objects with aspect ratings", () => {
      const plainReviews = [
        {
          id: 1,
          cleaningQuality: 5.0,
    ...
    it("should serialize cleaner-to-homeowner aspects from plain objects", () => {
      const plainReviews = [
        {
          id: 1,
          accuracyOfDescription: 4.5,
    ...
    it("should handle plain object with reviewer association", () => {
      const plainReviews = [
        {
          id: 1,
          review: 4.5,
    ...
    it("should handle plain object with reviewerName for deleted reviewer", () => {
      const plainReviews = [
        {
          id: 1,
          review: 4.5,
      ...
      expect(result[0].reviewer).toBeTruthy();
      expect(result[0].reviewer.id).toBeNull();
      expect(result[0].reviewer.displayName).toBe("Deleted User");
    });

    it("should handle multiple plain objects", () => {
      const plainReviews = [
        { id: 1, review: 5.0, reviewComment: "Excellent!" },
        { id: 2, review: 4.0, reviewComment: "Good" },
        { id: 3, review: 3.0, reviewComment: "Average" },
      ];
    ...
    it("should handle mixed array of Sequelize instances and plain objects", () => {
      const mixedReviews = [
        {
          dataValues: {
            id: 1,
            review: 5.0,
            reviewComment: "From Sequelize",
          },
        },
        {
          id: 2,
          review: 4.0,
          reviewComment: "Plain object",
        },
      ];

      const result = ReviewSerializer.serializeArray(mixedReviews);

      expect(result).toHaveLength(2);
      expect(result[0].id).toBe(1);
      expect(result[0].reviewComment).toBe("From Sequelize");
      expect(result[1].id).toBe(2);
      expect(result[1].reviewComment).toBe("Plain object");
    });

    it("should handle plain object with null/undefined values", () => {
      const plainReviews = [
        {
          id: 1,
          review: 4.5,
      ...
      expect(result[0].review).toBe(4.5);
      expect(result[0].cleaningQuality).toBeNull();
      expect(result[0].punctuality).toBeUndefined();
      expect(result[0].reviewComment).toBeNull();
    });

    it("should handle plain object with boolean false values", () => {
      const plainReviews = [
        {
          id: 1,
          review: 2.0,
