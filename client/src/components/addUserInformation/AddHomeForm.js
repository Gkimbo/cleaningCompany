        ...
        <View style={styles.toggleCardContent}>
          ...
          <Text style={styles.toggleCardDescription}>
            {homeData.towelsProvided === "yes" && homeData.bathroomConfigurations.length > 0
              ...
              : homeData.numBaths ? `${Math.ceil(parseFloat(homeData.numBaths))} bathrooms - $${(pricing.linens.towelFee / 100).toFixed(0)}/towel, $${(pricing.linens.faceClothFee / 100).toFixed(0)}/face cloth` : "Select to configure towels for each bathroom"}
          </Text>
        </View>
        <View
          style={[
