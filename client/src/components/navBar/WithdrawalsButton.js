...
const WithdrawalsButton = ({ closeModal }) => {
  ...
  return (
    <Pressable
      ...
      onPress={handlePress}
    >
      <Feather name="credit-card" size={18} color="#E5E7EB" style={{ marginRight: 12 }} />
      <Text style={ButtonStyles.buttonText}>Withdrawals</Text>
    </Pressable>
  );
};
